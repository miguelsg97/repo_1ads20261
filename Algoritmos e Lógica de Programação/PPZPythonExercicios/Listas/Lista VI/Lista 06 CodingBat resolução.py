...
def dormir(dia_semana, feriado):
  #assista o vídeo da explicação caso não entenda
...
def papagaio(falando, hora):
  #cuidado com a precedência, and é como multiplicação
  #e or como soma, se não tiver os parênteses abaixo
  #fará falando and hora < 7 antes do outro or

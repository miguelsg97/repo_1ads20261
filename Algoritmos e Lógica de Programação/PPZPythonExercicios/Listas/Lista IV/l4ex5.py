print('Encontrando letras de "PYTHON" em palavras com mais de quatro caracteres em um texto')
print()
...
print(f'Palavras que possuem letras de "PYTHON" e mais de quatro caracteres: {palavras}.')
